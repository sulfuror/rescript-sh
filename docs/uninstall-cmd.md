...
Running the command will present an interactive menu allowing you to choose between a system-wide or user-level uninstallation (mirroring the installation options).
